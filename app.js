...
const session = {
    url : '/',
    user : 'Player',
    urlStack : ['/'],     // no implementation yet
};
...
app.get('/devInfo', (req, res) => {
	res.render('devInfo', {session});
});

app.get('/instructions', (req, res) => {
	res.render('instructions', {session});
});

app.get('/t&c', (req, res) => {
	res.render('t&c', {session});
});

app.get('/404', (req, res) => {
	res.render('404', {session});
});
